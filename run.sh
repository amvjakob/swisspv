...
time srun python train_classification_tl.py --ckpt_load=keras_swisspv_untrained.h5 --epochs=500 --batch_size=128 --epochs_ckpt=5 --train_set=train.pickle --test_set=test.pickle --validation_split=0.1 --skip_train=False --skip_test=False --fine_tune_layers=4 --verbose=1
